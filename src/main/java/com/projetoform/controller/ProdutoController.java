package com.projetoform.controller;
...
import com.projetoform.service.ProdutoService;
...
public class ProdutoController {
	...
	@PutMapping("/{id}")
	public ResponseEntity<Produto> alteraCursosControl(@PathVariable Long id, @RequestBody @Valid Produto produto){
